...
/*================================================================ API =============================================================================*/
/**  
 * @brief Dynamically create a new vector object of given capacity and block size 
 ...
 * @retval VECTOR_UNITIALIZED_ERROR vector = NULL 
 * @retval VECTOR_ALLOCATION_ERROR realloc failed
 * @retval VECTOR_OVERFLOW_ERROR vector full and block=0
 * @complexity O(1)
 */
 ...
 * @return success or error code 
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR vector = NULL or pointer to variable null
 * @retval VECTOR_UNDERFLOW_ERROR vector empty
 ...
 * @return success or error code 
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR vector = NULL or pointer to variable is null
 * @retval VECTOR_INDEX_OUT_OF_BOUNDS_ERROR index < 1 or index > num of element 
 * @complexity O(1)
 *
 ...
 * @param[in] _vector - Vector to use.
 * @return  capacity of vector or 0 if vector invalid		
 */
 ...
 *		return i;
 * 
 * @warning return 0 if any of the pointers is null
 *
 */

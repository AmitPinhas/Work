...
extern "C" void SprinklerControllerCreatorRegistration(ICreatorsRegistrator & a_creatorRegistrator);
...
//void Registration(ICreatorsRegistrator & a_creatorRegistrator);

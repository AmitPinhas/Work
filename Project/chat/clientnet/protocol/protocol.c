...
int ProtocolUnpackSignup(SignUp* _signup ,char* _msg)
{
    ...
    loc += LENGHT_SIZE;
    memcpy((void*) &_signup->m_value, (void*) &_msg[loc],  _signup->m_length);
    loc +=  _signup->m_length;
...
int ProtocolPackSignup (SignUp* _signup, char* _msg)
{
	...
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_signup->m_value, (_signup->m_length));
	loc +=  (_signup->m_length);
...
int ProtocolUnpackLogIn(LogIn* _logIn ,char* _msg)
{
    ...
    loc += LENGHT_SIZE;
    memcpy((void*) &_logIn->m_value, (void*) &_msg[loc],  _logIn->m_length);
    loc +=  _logIn->m_length;
...
int ProtocolPackLogIn (LogIn* _logIn, char* _msg)
{
	...
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_logIn->m_value, (_logIn->m_length));
	_msg[loc] +=  (_logIn->m_length);
...
int ProtocolPackResponse (Response* _response, char* _msg)
{
	...
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_response->m_value, (_response->m_length));
	loc +=  (_response->m_length);
    return loc;
}
...
int ProtocolUnpackResponse(Response* _response ,char* _msg)
{
    ...
    loc += LENGHT_SIZE;
    memcpy((void*) &_response->m_value, (void*) &_msg[loc],  _response->m_length);
    loc +=  _response->m_length;
    return loc;
}
...
int ProtocolPackCreateGroup (CreateGroup* _createGroup, char* _msg)
{
	...
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_createGroup->m_value, (_createGroup->m_length));
	_msg[loc] +=  (_createGroup->m_length);
...
int ProtocolUnpackCreateGroup(CreateGroup* _createGroup ,char* _msg)
{
    ...
    loc += LENGHT_SIZE;
    memcpy((void*) &_createGroup->m_value, (void*) &_msg[loc],  _createGroup->m_length);
    loc +=  _createGroup->m_length;
...
int ProtocolPackRespGroup (RespGroup* _respGroup, char* _msg)
{
	...
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_respGroup->m_value, (_respGroup->m_length));
	_msg[loc] +=  (_respGroup->m_length);
...
int ProtocolUnpackRespGroup(RespGroup* _respGroup ,char* _msg)
{
    ...
    loc += LENGHT_SIZE;
    memcpy((void*) &_respGroup->m_value, (void*) &_msg[loc],  _respGroup->m_length);
    loc +=  _respGroup->m_length;
...
int ProtocolPackJoinGroup (JoinGroup* _joinGroup, char* _msg)
{
	...
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_joinGroup->m_value, (_joinGroup->m_length));
	_msg[loc] +=  (_joinGroup->m_length);
...
int ProtocolUnpackJoinGroup(JoinGroup* _joinGroup ,char* _msg)
{
    ...
    loc += LENGHT_SIZE;
    memcpy((void*) &_joinGroup->m_value, (void*) &_msg[loc],  _joinGroup->m_length);
    loc +=  _joinGroup->m_length;
...
int ProtocolPackLeaveGroup (LeaveGroup* _leaveGroup, char* _msg)
{
	...
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_leaveGroup->m_value, (_leaveGroup->m_length));
	_msg[loc] +=  (_leaveGroup->m_length);
...
int ProtocolUnpackLeaveGroup(LeaveGroup* _leaveGroup ,char* _msg)
{
    ...
    loc += LENGHT_SIZE;
    memcpy((void*) &_leaveGroup->m_value, (void*) &_msg[loc],  _leaveGroup->m_length);
    loc +=  _leaveGroup->m_length;
...
int ProtocolPackRespGroupsList(RespGroupsList *_respGroupList, char* _msg) 
{
	...
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_respGroupList->m_value, (_respGroupList->m_length));
	loc +=  (_respGroupList->m_length);
...
int ProtocolUnpackRespGroupsList(RespGroupsList *_respGroupList, char* _msg) 
{
    ...
    loc += LENGHT_SIZE;
    memcpy((void*) &_respGroupList->m_value, (void*) &_msg[loc],  _respGroupList->m_length);
    loc +=  _respGroupList->m_length;
    for ( i = 0 ; i < _respGroupList->m_value ; ++i )
    {
...
int ProtocolPackLogOut (LogOut* _logOut, char* _msg)
{
	...
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_logOut->m_value, (_logOut->m_length));
	_msg[loc] +=  (_logOut->m_length);
...
int ProtocolUnpackLogOut(LogOut* _logOut ,char* _msg)
{
    ...
    loc += LENGHT_SIZE;
    memcpy((void*) &_logOut->m_value, (void*) &_msg[loc],  _logOut->m_length);
    loc +=  _logOut->m_length;
    ProtocolUnpackName(&_logOut->m_userName, _msg, &loc);
    return loc;
}

/* ------------------------- Pack ReqGroupsList --------------------------- */
int ProtocolPackReqGroupsList (ReqGroupsList* _reqGroupsList, char* _msg)
{
	int loc = 0;
    
	memcpy((void*) &_msg[loc], &_reqGroupsList->m_type, TYPE_SIZE);
	loc += TYPE_SIZE;
	memcpy((void*) &_msg[loc], &_reqGroupsList->m_length, LENGHT_SIZE);
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_reqGroupsList->m_value, (_reqGroupsList->m_length));
	loc +=  (_reqGroupsList->m_length);
    return loc;
}

/* ------------------------- Unpack ReqGroupsList ------------------------ */
int ProtocolUnpackReqGroupsList(ReqGroupsList* _reqGroupsList ,char* _msg)
{
    int loc = 0;

    memcpy((void*) &_reqGroupsList->m_type, (void*) &_msg[loc], TYPE_SIZE);
    loc += TYPE_SIZE;
    memcpy((void*) &_reqGroupsList->m_length, (void*) &_msg[loc], LENGHT_SIZE);
    loc += LENGHT_SIZE;
    memcpy((void*) &_reqGroupsList->m_value, (void*) &_msg[loc],  _reqGroupsList->m_length);
    loc +=  _reqGroupsList->m_length;
    return loc;
}

/* ------------------------- Unpack MsgData ------------------------ */
int ProtocolUnpackMsgData(MsgData* _MsgData ,char* _msg)
{
    int loc = 0;

    memcpy((void*) &_MsgData->m_type, (void*) &_msg[loc], TYPE_SIZE);
    loc += TYPE_SIZE;
    memcpy((void*) &_MsgData->m_length, (void*) &_msg[loc], LENGHT_SIZE);
    loc += LENGHT_SIZE;
    memcpy((void*) &_MsgData->m_value, (void*) &_msg[loc],  _MsgData->m_length);
    loc +=  _MsgData->m_length;
    ProtocolUnpackName(&_MsgData->m_userName, _msg, &loc);
    ProtocolUnpackMsg(&_MsgData->m_message, _msg, &loc);
    return loc;
}

/* ------------------------- Pack MsgData --------------------------- */
int ProtocolPackMsgData (MsgData* _MsgData, char* _msg)
{
	int loc = 0;

    memcpy((void*) &_msg[loc], &_MsgData->m_type, TYPE_SIZE);
	loc += TYPE_SIZE;
	memcpy((void*) &_msg[loc], &_MsgData->m_length, LENGHT_SIZE);
	loc += LENGHT_SIZE;
	memcpy((void*) &_msg[loc], &_MsgData->m_value, (_MsgData->m_length));
	_msg[loc] +=  (_MsgData->m_length);
	ProtocolPackName(&_MsgData->m_userName, _msg, &loc) ;
	ProtocolPackMsg (&_MsgData->m_message, _msg, &loc) ;
	return loc;
}
/* ========================= local func ============================= */
...
int ProtocolUnpackName(Name* _name, char* _msg, int* _loc)
{
    ...
    *_loc += LENGHT_SIZE;
    memcpy((void*) &_name->m_value, (void*) &_msg[*_loc],  _name->m_length);
    *_loc +=  _name->m_length;
...
int ProtocolPackName(Name* _name, char* _msg, int* _loc)
{
    ...
    *_loc += LENGHT_SIZE;
    memcpy((void*) &_msg[*_loc], &_name->m_value,  _name->m_length);
    *_loc +=  _name->m_length;
    return *_loc;
}
...
int ProtocolUnpackPassword (Password* _passowrd, char* _msg, int* _loc)
{
    ...
    *_loc += LENGHT_SIZE;
    memcpy((void*) &_passowrd->m_value, (void*) &_msg[*_loc],  _passowrd->m_length);
    *_loc +=  _passowrd->m_length;
...
int ProtocolPackPassword (Password* _passowrd, char* _msg, int* _loc)
{
    ...
    *_loc += LENGHT_SIZE;
    memcpy((void*) &_msg[*_loc], &_passowrd->m_value,  _passowrd->m_length);
    *_loc +=  _passowrd->m_length;
    return *_loc;
}
...
int ProtocolUnpackIpNumber (IpNumber* _ipNumber, char* _msg, int* _loc)
{
    ...
    *_loc += LENGHT_SIZE;
    memcpy((void*) &_ipNumber->m_value, (void*) &_msg[*_loc],  _ipNumber->m_length);
    *_loc +=  _ipNumber->m_length;
...
int ProtocolPackIpNumber (IpNumber* _ipNumber, char* _msg, int* _loc)
{
    ...
    *_loc += LENGHT_SIZE;
    memcpy((void*) &_msg[*_loc], &_ipNumber->m_value,  _ipNumber->m_length);
    *_loc +=  _ipNumber->m_length;
    return *_loc;
}

/* ------------------------- Unpack Msg --------------------------- */
int ProtocolUnpackMsg(Msg* _msgType, char* _msg, int* _loc)
{
    memcpy((void*) &_msgType->m_type, (void*) &_msg[*_loc], TYPE_SIZE);
    *_loc += TYPE_SIZE;
    memcpy((void*) &_msgType->m_length, (void*) &_msg[*_loc], LENGHT_SIZE);
    *_loc += LENGHT_SIZE;
    memcpy((void*) &_msgType->m_value, (void*) &_msg[*_loc],  _msgType->m_length);
    *_loc +=  _msgType->m_length;
    _msgType->m_value[(int) _msgType->m_length] = '\0';
    return *_loc;
}

/* ------------------------- Pack Msg --------------------------- */
int ProtocolPackMsg(Msg* _msgType, char* _msg, int* _loc)
{
    memcpy((void*) &_msg[*_loc], &_msgType->m_type, TYPE_SIZE);
    *_loc += TYPE_SIZE;
    memcpy((void*) &_msg[*_loc], &_msgType->m_length, LENGHT_SIZE);
    *_loc += LENGHT_SIZE;
    memcpy((void*) &_msg[*_loc], &_msgType->m_value,  _msgType->m_length);
    *_loc +=  _msgType->m_length;
    return *_loc;
}
#ifndef __HEAP_H__
#define __HEAP_H__
#include "vector.h" /* Vector typdef */ 
 ...
 * @warning return null if heap is null 
 */
 ...
 * @warning return 0 if heap is null 
 */
 ...
 * @param[in] _pfLess
 * @warning if fail or if any of the pointers is null will return without sorting
 */
